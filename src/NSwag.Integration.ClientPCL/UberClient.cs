...
namespace Uber
{
    ...
    public partial class Client 
    {
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Product>> GetsAllProductsAsync(double latitude, double longitude)
        {
            return GetsAllProductsAsync(latitude, longitude, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>An array of products</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Product>> GetsAllProductsAsync(double latitude, double longitude, System.Threading.CancellationToken cancellationToken)
        {
            if (latitude == null)
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<PriceEstimate>> GetsAllEstimatePricesAsync(double start_latitude, double start_longitude, double end_latitude, double end_longitude)
        {
            return GetsAllEstimatePricesAsync(start_latitude, start_longitude, end_latitude, end_longitude, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>An array of price estimates by product</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<PriceEstimate>> GetsAllEstimatePricesAsync(double start_latitude, double start_longitude, double end_latitude, double end_longitude, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>An array of products</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Product>> GetsAllEstimateTimesByParametersAsync(double start_latitude, double start_longitude, System.Guid? customer_uuid, string product_id)
        {
            return GetsAllEstimateTimesByParametersAsync(start_latitude, start_longitude, customer_uuid, product_id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>An array of products</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Product>> GetsAllEstimateTimesByParametersAsync(double start_latitude, double start_longitude, System.Guid? customer_uuid, string product_id, System.Threading.CancellationToken cancellationToken)
        {
            if (start_latitude == null)
                throw new System.ArgumentNullException("start_latitude");
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Profile> GetsMeAsync()
        {
            return GetsMeAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Profile information for a user</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Profile> GetsMeAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Activities> GetsHistoryAsync(int? offset, int? limit)
        {
            return GetsHistoryAsync(offset, limit, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>History information for the given user</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Activities> GetsHistoryAsync(int? offset, int? limit, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
