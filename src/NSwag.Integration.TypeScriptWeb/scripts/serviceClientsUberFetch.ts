...
export class Client {
     ...
     */
    getsAllProducts(latitude: number, longitude: number): Promise<Product[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetsAllProducts(_response);
        });
    }

    protected processGetsAllProducts(response: Response): Promise<Product[]> {
     ...
     */
    getsAllEstimatePrices(start_latitude: number, start_longitude: number, end_latitude: number, end_longitude: number): Promise<PriceEstimate[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetsAllEstimatePrices(_response);
        });
    }

    protected processGetsAllEstimatePrices(response: Response): Promise<PriceEstimate[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return An array of products
     */
    getsAllEstimateTimesByParameters(start_latitude: number, start_longitude: number, customer_uuid: string | null | undefined, product_id: string | null | undefined): Promise<Product[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetsAllEstimateTimesByParameters(_response);
        });
    }

    protected processGetsAllEstimateTimesByParameters(response: Response): Promise<Product[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getsMe(): Promise<Profile> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetsMe(_response);
        });
    }

    protected processGetsMe(response: Response): Promise<Profile> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     */
    getsHistory(offset: number | null | undefined, limit: number | null | undefined): Promise<Activities> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetsHistory(_response);
        });
    }

    protected processGetsHistory(response: Response): Promise<Activities> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
